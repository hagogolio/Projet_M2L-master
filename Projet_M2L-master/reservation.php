    ...
    <tbody>
   	<?php
			...
			foreach($formationEmploye as $uneFormation)
			{
                ...
                echo "<td><a data-toggle='modal'' data-target='#editBox' href='modal.php?id=$uneFormation->idFormation' class='btn btn-m btn-info'><span class='glyphicon glyphicon-search'></span> Détail</a><td>";
                echo "<td><input  class='btn btn-success btn btn-success' type='submit' value='Choisir'/><td>";
                echo "</tr>";
